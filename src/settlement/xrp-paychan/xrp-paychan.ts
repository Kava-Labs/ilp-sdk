...
import { LedgerEnv, State, SettlementModule } from '../../api'
import {
  UplinkConfig,
...
export const deposit = (state: State) => (
...
export type XrpPaychanSettlementModule = SettlementModule<
...
// TODO Rename this?
export const settlementModule: XrpPaychanSettlementModule = {
  setupEngine,
  setupCredential,
  uniqueId,
  closeCredential,
